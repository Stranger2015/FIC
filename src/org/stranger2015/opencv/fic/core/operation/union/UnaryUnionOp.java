...
public class UnaryUnionOp
{
    ...
    {
        org.locationtech.jts.operation.union.UnaryUnionOp op = new org.locationtech.jts.operation.union.UnaryUnionOp(geoms);
        return op.union();
    }
    ...
    {
        org.locationtech.jts.operation.union.UnaryUnionOp op = new org.locationtech.jts.operation.union.UnaryUnionOp(geoms, geomFact);
        return op.union();
    }
    ...
    {
        org.locationtech.jts.operation.union.UnaryUnionOp op = new org.locationtech.jts.operation.union.UnaryUnionOp(geom);
        return op.union();
    }
