package org.stranger2015.opencv.fic.core.operation.buffer;
...
public class BufferOp
{
  ...
  */
    ...
    {
        org.locationtech.jts.operation.buffer.BufferOp gBuf = new org.locationtech.jts.operation.buffer.BufferOp(g);
...
//BufferDebug.saveBuffer(geomBuf);
    ...
    {
        org.locationtech.jts.operation.buffer.BufferOp bufOp = new org.locationtech.jts.operation.buffer.BufferOp(g, params);
    ...
    {
        org.locationtech.jts.operation.buffer.BufferOp bufOp = new org.locationtech.jts.operation.buffer.BufferOp(g);
    ...
    public static Geometry bufferByZero(Geometry geom, boolean isBothOrientations) {
        ...
        org.locationtech.jts.operation.buffer.BufferOp op = new org.locationtech.jts.operation.buffer.BufferOp(geom);
