...
class STRtree
    ...
    class STRtreeNode extends AbstractNode {
        ...
        Object computeBounds () {
            ...
            for (Boundable childBoundable : (Iterable <Boundable>) getChildBoundables()) {
                if (bounds == null) {
    ...
    private static final AbstractSTRtree.IntersectsOp intersectsOp = new IntersectsOp() {
        public
    ...
    private
    Object[] nearestNeighbourK ( BoundablePair initBndPair, double maxDistance, int k ) {
    ...
    private static
    Object[] getItems ( PriorityQueue kNearestNeighbors ) {
        /**
