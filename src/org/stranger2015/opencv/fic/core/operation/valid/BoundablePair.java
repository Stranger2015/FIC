 ...
 */
class BoundablePair
        implements Comparable<Boundable> {
     ...
     */
    public
    int compareTo ( BoundablePair nd ) {
    ...
    public static
    boolean isComposite ( Boundable item ) {
        return (item instanceof AbstractNode);
    }

    private static
    double area ( Boundable b ) {
    ...
    private
    void expand ( Boundable bndComposite, Boundable bndOther, boolean isFlipped,
    ...
    @Override
    public
    int compareTo ( @NotNull Boundable o ) {
        return 0;
    }
}
