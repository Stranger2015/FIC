...
import org.stranger2015.opencv.fic.core.io.ParseException;
//import org.stranger2015.opencv.fic.core.io.WKTWriter;
import org.stranger2015.opencv.fic.utils.Assert;
import org.stranger2015.opencv.fic.utils.AssertionFailedException;
 ...
 *
 *@version 1.8
 * @see  org.stranger2015.opencv.fic.core.io.WKTWriter
 */
public class WKTReader
{
    ...
    ICoordinateSequence getCoordinateSequenceOldMultiPoint( StreamTokenizer tokenizer,
        ...
        do {
            coordinates.add((Coordinate) getCoordinate(tokenizer, ordinateFlags, true));
        } while (getNextCloserOrComma(tokenizer).equals(COMMA));
     ...
     */
    private
    MultiPolygon readMultiPolygonText( StreamTokenizer tokenizer, EnumSet<Ordinate> ordinateFlags) throws IOException, ParseException {
        String nextToken = getNextEmptyOrOpener(tokenizer);
        if (nextToken.equals(WKTConstants.EMPTY)) {
