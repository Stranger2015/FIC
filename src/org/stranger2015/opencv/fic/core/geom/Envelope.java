...
class Envelope
     ...
     */
    public static
    boolean intersects ( Coordinate p1, Coordinate p2, Coordinate q ) {
     ...
     */
    public static
    boolean intersects ( Coordinate p1, Coordinate p2, Coordinate q1, Coordinate q2 ) {
    ...
    public
    Coordinate centre () {
        return isNull() ? null : new Coordinate(
                (getMinX() + getMaxX()) / 2.0,
                (getMinY() + getMaxY()) / 2.0);
    }
     ...
     */
    public
    int compareTo ( @NotNull Envelope env ) {
//        Envelope env = o;
