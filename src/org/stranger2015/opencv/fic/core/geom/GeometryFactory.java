...
public class GeometryFactory implements Serializable {
     ...
     */
    public static Point[] toPointArray( Collection<Point> points) {
     ...
     *@return              the <code>List</code> in array format
     */
    public static LinearRing[] toLinearRingArray( Collection<LinearRing> linearRings) {
     ...
     *@return              the <code>List</code> in array format
     */
    public static LineString[] toLineStringArray( @NotNull Collection<LineString> lineStrings) {
     ...
     */
    public static Polygon[] toPolygonArray( Collection <Polygon> polygons) {
     ...
     *@return                the <code>List</code> in array format
     */
    public static MultiPolygon[] toMultiPolygonArray( Collection<MultiPolygon> multiPolygons) {
     ...
     *@return                   the <code>List</code> in array format
     */
    public static MultiLineString[] toMultiLineStringArray(Collection<MultiLineString> multiLineStrings) {
     ...
     *@return              the <code>List</code> in array format
     */
    public static MultiPoint[] toMultiPointArray( Collection<MultiPoint> multiPoints) {
    ...
    public <T extends Geometry>  T buildGeometry(Collection<T> geomList) {
        ...
        if (isHeterogeneous || hasGeometryCollection) {
            return createGeometryCollection(toGeometryArray((Collection <Geometry>) geomList));
        }
