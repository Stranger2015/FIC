 ...
 */
public
class PrecisionModel implements Serializable, Comparable <PrecisionModel> {
    /**
    ...
    @Override
    public
    int compareTo ( @NotNull PrecisionModel other ) {
     ...
     */
    public static final PrecisionModel.Type FIXED = new PrecisionModel.Type("FIXED");
    /**
     * Floating precision corresponds to the standard Java
     * double-precision floating-point representation, which is
     * based on the IEEE-754 standard
     */
    public static final PrecisionModel.Type FLOATING = new PrecisionModel.Type("FLOATING");
    /**
     * Floating single precision corresponds to the standard Java
     * single-precision floating-point representation, which is
     * based on the IEEE-754 standard
     */
    public static final PrecisionModel.Type FLOATING_SINGLE = new PrecisionModel.Type("FLOATING SINGLE");
     ...
     */
    private final PrecisionModel.Type modelType;
    /**
