        ...
        extends ArrayList<Coordinate>
{
     ...
     * (I.e. this constructor produces a {@link org.stranger2015.opencv.fic.core.geom.CoordinateList} with exactly the same set of points
     * as the input array.)
     *
    ...
    public Coordinate[] toCoordinateArray(boolean isForward)
    {
        ...
        return IntStream.range(0, size).mapToObj(i -> get(size - i - 1)).toArray(Coordinate[]::new);
    }
    ...
    public Object clone() {
        ...
        IntStream.range(0, this.size()).forEachOrdered(i -> clone.add(i, (Coordinate) this.get(i).clone()));
