...
class Geometry implements Cloneable, Comparable <Geometry>, Serializable {
     ...
     *
     * @see #apply(IGeometryComponentFilter)
     */
    protected
     ...
     * returns a {@link IPolygonal} geometry (unlike {@link #union(Geometry)},
    ...
    protected
    boolean equal ( Coordinate a, Coordinate b, double tolerance ) {
        return tolerance == 0 ? a.equals(b) : a.distance(b) <= tolerance;
    }
     ...
     * @param other a <code>Geometry</code> with which to compare this <code>Geometry</code>
     * @return a positive number, 0, or a negative number, depending on whether
     * this object is greater than, equal to, or less than <code>other</code>, as
     * defined in "Normal Form For Geometry" in the JTS Technical
     * Specifications
     */
    @Override
