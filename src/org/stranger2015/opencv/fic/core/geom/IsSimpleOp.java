...
class IsSimpleOp {
     ...
     */
    public
    void setFindAllLocations ( boolean isFindAll ) {
    ...
    private
    boolean isSimpleMultiPoint ( MultiPoint mp ) {
     ...
     */
    private
    boolean isSimplePolygonal ( Geometry geom ) {
        boolean isSimple = true;
     ...
     */
    private
    boolean isSimpleGeometryCollection ( Geometry geom ) {
        boolean isSimple = true;
    ...
    private
    boolean isSimpleLinearGeometry ( Geometry geom ) {
        if (geom.isEmpty()) {
            return true;
        }
    ...
    class NonSimpleIntersectionFinder
        ...
        public
        NonSimpleIntersectionFinder ( boolean isClosedEndpointsInInterior,
                                      boolean isFindAll,
         ...
         */
        private static
        int intersectionVertexIndex ( LineIntersector li, int segmentIndex ) {
