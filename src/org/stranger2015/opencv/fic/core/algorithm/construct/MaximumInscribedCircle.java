...
import org.stranger2015.opencv.fic.core.algorithm.locate.IndexedPointInAreaLocator;
...
public class MaximumInscribedCircle {
     ...
     */
    public static
    Point getCenter( Geometry polygonal, double tolerance) {
        MaximumInscribedCircle mic = new org.locationtech.jts.algorithm.construct.MaximumInscribedCircle(polygonal, tolerance);
     ...
     */
    public static
    LineString getRadiusLine( Geometry polygonal, double tolerance) {
        org.locationtech.jts.algorithm.construct.MaximumInscribedCircle mic = new org.locationtech.jts.algorithm.construct.MaximumInscribedCircle(polygonal, tolerance);
    ...
    private org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell centerCell = null;
    ...
    private void compute() {
        ...
        PriorityQueue<org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell> cellQueue = new PriorityQueue <>();

        createInitialGrid(inputGeom.getEnvelopeInternal(), cellQueue);

        // use the area centroid as the initial candidate center point
        org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell farthestCell = createCentroidCell(inputGeom);
        ...
        while (! cellQueue.isEmpty()) {
            ...
            org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell cell = cellQueue.remove();
     ...
     */
    private void createInitialGrid(Envelope env, PriorityQueue<org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell> cellQueue) {
    ...
    private
    org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell createCell( double x, double y, double hSide) {
        return new org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell(x, y, hSide, distanceToBoundary(x, y));
    }

    // create a cell centered on area centroid
    private
    org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell createCentroidCell( Geometry geom) {
        Point p = geom.getCentroid();
        return new org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell(p.getX(), p.getY(), 0, distanceToBoundary(p));
    }
     ...
     *
     */
    private static class Cell implements Comparable<org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell> {
         ...
         */
        public int compareTo( org.locationtech.jts.algorithm.construct.MaximumInscribedCircle.Cell o) {
