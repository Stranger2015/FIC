...
public class FacetSequence
{
     ...
     */
    public double distance( org.locationtech.jts.operation.distance.FacetSequence facetSeq)
    {
     ...
     */
    public GeometryLocation[] nearestLocations( org.locationtech.jts.operation.distance.FacetSequence facetSeq)
    {
        boolean isPoint = isPoint();
        boolean isPointOther = facetSeq.isPoint();
    ...
    private double computeDistanceLineLine( org.locationtech.jts.operation.distance.FacetSequence facetSeq, GeometryLocation[] locs)
    {
    ...
    private void updateNearestLocationsLineLine( int i, Coordinate p0, Coordinate p1, org.locationtech.jts.operation.distance.FacetSequence facetSeq, int j,
    ...
    private double computeDistancePointLine( Coordinate pt, org.locationtech.jts.operation.distance.FacetSequence facetSeq, GeometryLocation[] locs)
    {
        double minDistance = Double.MAX_VALUE;
    ...
    private void updateNearestLocationsPointLine( Coordinate pt,
                                                  org.locationtech.jts.operation.distance.FacetSequence facetSeq, int i, Coordinate q0, Coordinate q1,
