...
public class InteriorPointArea {
    ...
    private static class InteriorPointPolygon {
        ...
        private void findBestMidpoint(List<Double> crossings) {
            ...
            IntStream.iterate(0, i -> i < crossings.size(), i -> i + 2).forEachOrdered(i -> {
  ...
  */
    ...
    private static class ScanLineYOrdinateFinder {
        ...
        double getScanLineY(Polygon<T> poly) {
        ...
        private void process(LineString line) {
            ...
            IntStream.range(0, seq.size()).mapToDouble(seq::getY).forEachOrdered(this::updateInterval);
        }
