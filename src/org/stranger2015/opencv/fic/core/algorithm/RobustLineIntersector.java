...
class RobustLineIntersector
    ...
    private
    int computeCollinearIntersection ( Coordinate p1, Coordinate p2,
...
//      checkDD(p1, p2, q1, q2, intPt);
    ...
    private
    void checkDD ( Coordinate p1, Coordinate p2, Coordinate q1,
     ...
     */
    private
    boolean isInSegmentEnvelopes ( Coordinate intPt ) {
     ...
     */
    private static
    Coordinate nearestEndpoint ( Coordinate p1, Coordinate p2,
                                                           Coordinate q1, Coordinate q2 ) {
