...
import org.stranger2015.opencv.fic.core.noding.Octant;

import static org.stranger2015.opencv.fic.core.io.WKTWriter.toLineString;
...
class BasicSegmentString
    ...
    int getSegmentOctant ( int index ) {
        return index == pts.length - 1 ? -1 : Octant.octant(getCoordinate(index), getCoordinate(index + 1));
    }

    public
    String toString () {
        return toLineString(new CoordinateArraySequence(pts));
    }
}
