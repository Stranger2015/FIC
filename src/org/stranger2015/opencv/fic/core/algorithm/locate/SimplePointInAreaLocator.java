 ...
 * relative to a {@link IPolygonal} {@link Geometry},
...
class SimplePointInAreaLocator
        implements IPointOnGeometryLocator {
     ...
     */
    public static
    boolean isContained ( Coordinate p, Geometry geom ) {
        return Location.EXTERIOR != locate(p, geom);
    }

    private static
    int locateInGeometry ( Coordinate p, Geometry geom ) {
        if (geom instanceof Polygon) {
            return locatePointInPolygon(
                    p,
                    (Polygon) geom);
        }
     ...
     */
    public static
    int locatePointInPolygon ( Coordinate p, Polygon<Geometry> poly ) {
        if (poly.isEmpty()) {
            return Location.EXTERIOR;
        }
     ...
     */
    public static
    boolean containsPointInPolygon ( Coordinate p, Polygon<Geometry> poly ) {
     ...
     */
    private static
    int locatePointInRing ( Coordinate p, LinearRing ring ) {
