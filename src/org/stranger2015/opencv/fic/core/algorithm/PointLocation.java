...
class PointLocation {
     ...
     */
    public static
    boolean isOnLine ( Coordinate p, Coordinate[] line ) {
     ...
     */
    public static
    boolean isOnLine ( Coordinate p, ICoordinateSequence line ) {
        LineIntersector lineIntersector = new RobustLineIntersector();
     ...
     */
    public static
    boolean isInRing ( Coordinate p, Coordinate[] ring ) {
     ...
     */
    public static
    int locateInRing ( Coordinate p, Coordinate[] ring ) {
