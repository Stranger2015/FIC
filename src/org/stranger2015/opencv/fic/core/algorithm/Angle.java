...
class Angle {
     ...
     */
    public static
    double angle ( Coordinate p0, Coordinate p1 ) {
        double dx = p1.x - p0.x;
        double dy = p1.y - p0.y;
     ...
     */
    public static
    boolean isAcute ( Coordinate p0, Coordinate p1, Coordinate p2 ) {
     ...
     */
    public static
    boolean isObtuse ( Coordinate p0, Coordinate p1, Coordinate p2 ) {
