...
import static org.stranger2015.opencv.fic.core.geom.Envelope.intersects;
...
class Distance {
     ...
     */
    public static
    double segmentToSegment ( Coordinate A, Coordinate B, Coordinate C, Coordinate D ) {
     ...
     */
    public static
    double pointToSegmentString ( Coordinate p, Coordinate[] line ) {
        if (line.length == 0)
     ...
     */
    public static
    double pointToSegment ( Coordinate p, Coordinate A,
                            Coordinate B ) {
     ...
     */
    public static
    double pointToLinePerpendicular ( Coordinate p, Coordinate A, Coordinate B ) {
