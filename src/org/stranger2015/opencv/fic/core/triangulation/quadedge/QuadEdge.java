...
import org.stranger2015.opencv.fic.core.io.WKTWriter;//fixme
import org.stranger2015.opencv.fic.core.geom.Coordinate;
import org.stranger2015.opencv.fic.core.geom.LineSegment;

/**
 * A class that represents the edge data structure which implements the quad edge algebra.
 * The quad edge algebra was described in a well-known paper by Guibas and Stolfi,
 ...
 * Quad edges in a subdivision are linked together via their <tt>next</tt> references.
 * The linkage between the quad edge quartets determines the topology of the subdivision.
 * <p>
...
//    * QuadEdges must be made using {@link makeEdge},
    ...
    /**
     * Creates a new QuadEdge connecting the destination of <tt>a</tt> to the origin of
     * <tt>b</tt>, in such a way that all three have the same left face after the
...
//    private int      visitedKey = 0;
    ...
    public
    QuadEdge getPrimary() {
        return orig().getCoordinate().compareTo(dest().getCoordinate()) <= 0
                ? this
                : sym();
    }
