...
import org.stranger2015.opencv.fic.core.algorithm.NotRepresentableException;
...
class Vertex {
    ...
    public
    String toString () {
        return format("Point( %f, %f )", p.x, p.y);
    }
     ...
     *
     * @return k X v (cross product). this is a vector perpendicular to v.
     */
    /* returns */
    Vertex cross () {
     ...
     */
    public
    double interpolateZ ( Coordinate v0, Coordinate v1, Coordinate v2 ) {
        double x0 = v0.x;
        double y0 = v0.y;
        double a = v1.x - x0;
        double b = v2.x - x0;
     ...
     */
    public
    double interpolateZ ( Coordinate p0, Coordinate p1 ) {
