 ...
 */
public
class ColorspaceHandler<T extends Enum<T>> extends EnumOptionHandler <T> {
     ...
     */
    public
    ColorspaceHandler ( CmdLineParser parser, OptionDef option, Setter <? super T> setter, Class <T> enumType ) {
