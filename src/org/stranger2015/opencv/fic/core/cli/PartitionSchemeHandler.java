 ...
 */
public
class PartitionSchemeHandler<T extends Enum<T>> extends EnumOptionHandler<T> {
    /**
     * @param parser
     * @param option
     * @param setter
     ...
     */
    public
    PartitionSchemeHandler ( CmdLineParser parser, OptionDef option, Setter <? super T> setter, Class <T> enumType ) {
