...
class Util {
    ...
    private static
    org.stranger2015.opencv.fic.core.enumus.enumus.initializer.ValueData createValueData( Annotation a) {
        return a instanceof Value ? createValueData((Value)a) : createValueDataFromStereotype(a);
    }


    private static
    org.stranger2015.opencv.fic.core.enumus.enumus.initializer.ValueData createValueData( Value v) {
        return new org.stranger2015.opencv.fic.core.enumus.enumus.initializer.ValueData(v.name(), v.value(), v.type(), v.factory(), v.factoryMethod(), new Object[0], new Object[0]); //, v.factoryMethod().isEmpty() ?  new Object[0] : new Object[] {v.value()});
    }


    private static
    org.stranger2015.opencv.fic.core.enumus.enumus.initializer.ValueData createValueDataFromStereotype( Annotation a) {
        ...
        return new org.stranger2015.opencv.fic.core.enumus.enumus.initializer.ValueData(name, value, type, factory, factoryMethod, factoryArguments, factoryMethodArguments);
    }
