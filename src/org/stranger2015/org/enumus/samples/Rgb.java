...
import org.stranger2015.opencv.fic.core.enumus.enumus.Mirror;
import org.stranger2015.opencv.fic.core.enumus.enumus.ValueOf;
import org.stranger2015.opencv.fic.core.enumus.enumus.ValueOfRange;
...
public enum Rgb {
    ...
    private static final ValueOfRange <Rgb, Integer> waveLength = new ValueOfRange (Rgb.class,
            e -> e.min, e -> e.max);
